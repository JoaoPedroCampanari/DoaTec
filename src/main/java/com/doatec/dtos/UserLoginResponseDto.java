...
public class UserLoginResponseDto {
    private Integer id; // Alterado de UUID para Integer
    private String nome;
    ...
    public Integer getId() { return id; } // Alterado de UUID para Integer
    public void setId(Integer id) { this.id = id; } // Alterado de UUID para Integer
